<?php
	...
	//print_r($_GET);
	$noVoiture = $noFilm = filter_input(INPUT_GET, 'voiture', FILTER_SANITIZE_NUMBER_INT);


	$SQL_VOITURE = "SELECT * from voiture WHERE id = :id";
	//echo $SQL_FILM;
	
	include "basededonnees.php";
	$requeteVoiture = $basededonnees->prepare($SQL_VOITURE);
	$requeteVoiture->bindParam(':id',$noVoiture, PDO::PARAM_INT);
