...
$requeteListeVoiture->bindParam(':marque', $marque, PDO::PARAM_STR);
$requeteListeVoiture->bindParam(':presentation', $presentation, PDO::PARAM_STR);
$requeteListeVoiture->bindParam(':moteur', $moteur, PDO::PARAM_STR);
$requeteListeVoiture->bindParam(':puissance', $puissance, PDO::PARAM_STR);
$requeteListeVoiture->bindParam(':consommation', $consommation, PDO::PARAM_STR);
$requeteListeVoiture->bindParam(':prix', $prix, PDO::PARAM_STR);
$requeteListeVoiture->bindParam(':description', $description, PDO::PARAM_STR);
$requeteListeVoiture->bindParam(':nom_image', $nom_image, PDO::PARAM_STR);
